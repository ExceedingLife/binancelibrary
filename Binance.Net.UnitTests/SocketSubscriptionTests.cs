...
namespace Binance.Net.UnitTests
{
    ...
    public class SocketSubscriptionTests
    {
        ...
        public async Task ValidateSpotExchangeDataSubscriptions()
        {
            ...
            var tester = new SocketSubscriptionValidator<BinanceSocketClient>(client, "Subscriptions/Spot/ExchangeData", "https://api.binance.us", "data", stjCompare: true);
        ...
        public async Task ValidateSpotAccountSubscriptions()
        {
            ...
            var tester = new SocketSubscriptionValidator<BinanceSocketClient>(client, "Subscriptions/Spot/Account", "https://api.binance.us", "data", stjCompare: true);
        ...
        public async Task ValidateUsdFuturesSubscriptions()
        {
            ...
            var tester = new SocketSubscriptionValidator<BinanceSocketClient>(client, "Subscriptions/UsdFutures", "https://fapi.binance.us", "data", stjCompare: true);
