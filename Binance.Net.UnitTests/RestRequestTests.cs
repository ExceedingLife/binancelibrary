...
namespace Binance.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateSpotAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/Spot/Account", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateSpotExchangeDataCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/Spot/ExchangeData", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateSpotTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/Spot/Trading", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/UsdFutures/Account", "https://fapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesExchangeDataCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/UsdFutures/ExchangeData", "https://fapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/UsdFutures/Trading", "https://fapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateUsdFuturesTradingAlgoCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/UsdFutures/Trading", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateCoinFuturesAccountCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/CoinFutures/Account", "https://dapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateCoinFuturesExchangeDataCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/CoinFutures/ExchangeData", "https://dapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateCoinFuturesTradingCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/CoinFutures/Trading", "https://dapi.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateGeneralBrokerageCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/General/Brokerage", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateGeneralCryptoLoansCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/General/CryptoLoans", "https://api.binance.us", IsAuthenticated, stjCompare: true);
        ...
        public async Task ValidateGeneralAutoInvestCalls()
        {
            ...
            var tester = new RestRequestValidator<BinanceRestClient>(client, "Endpoints/General/AutoInvest", "https://api.binance.us", IsAuthenticated, stjCompare: true);
